...
<footer>
    <footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
        ...
        <p>Powered by <a href="#" target="_blank">Group G</a></p>
        <div style="position: relative;top:-100px; left: 200px" class="w3-left">

            <p><a href="http://campusmoodle.rgu.ac.uk/public/policy/policy.html" target="_blank">User Policy</a> and
                <a href="http://campusmoodle.rgu.ac.uk/public/policy/policy.html" target="_blank">Data Protection</a>
            </p> 2020 <a href="index.php" target="_blank">RGU Vegan Project</a>
        </div>
        <div style="position: relative;top:-130px; right: 20px" class="w3-right">
            <p> <strong>Contact Us : </strong> Garthdee House, Garthdee Road,
                Aberdeen AB10 7QB, Scotland, United Kingdom</p>
            <p><a href="mailto:1909248@rgu.ac.uk" target="_blank">RguVeganProject@rgu.ac.uk</a> +446947586897</p>
        </div>
